<div class="sidebar p-3 rounded-r-full">
    <a class="link-text" href="{{ url('/') }}">
        <div class="logo-sidebar mb-4 d-flex flex-row align-items-center gap-2">
            ...
            <div class="title-sidebar poppins-semibold fw-semibold fs-6">
                Webgis Project
            </div>
        </div>
    </a>
    <div class="field-sidebar">
        <ul class="list-unstyled">
            <li>
                <a href="{{ url('/') }}"
                    class="d-flex text-decoration-none align-items-center gap-4 poppins-regular fw-regular fs-6">
